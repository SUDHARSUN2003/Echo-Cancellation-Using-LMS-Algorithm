...
xlabel('Time [sec]');
ylabel('Amplitude');
title('Error (Echo) extracted by lms');
set(gcf, 'Color', [1 1 1])
...
axis([0 33.5 -1 1]);
ylabel('Amplitude');
title('Output of LMS Echo Canceller, \mu = 0.025');
subplot(3,1,3);
plot(t,e2(n),'r');
axis([0 33.5 -1 1]);
xlabel('Time [sec]');
ylabel('Amplitude');
title('Output of LMS Acoustic Echo Canceller, \mu = 0.04');
set(gcf, 'Color', [1 1 1])
